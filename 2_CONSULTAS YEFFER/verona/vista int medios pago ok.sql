...
/****** Object:  View [dbo].[V_Int_MedPag_corregido_vr]    Script Date: 27/03/2026 2:52:47 p. m. ******/
SET ANSI_NULLS ON
GO
...
CREATE View [dbo].[V_Int_MedPag_corregido_vr] as
SELECT 
    ...
    ISNULL(CASE 
        WHEN MtMedPag.CODIGOCTA like '%110505%' THEN 
